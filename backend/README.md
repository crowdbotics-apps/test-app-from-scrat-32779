...
## Project Structure
    ...
    ├── test_app_from_scrat_32779  # Django project configurations
...
1. Clone this repo and `cd test_app_from_scrat_32779`
...
2. Clone this repo and `cd test_app_from_scrat_32779`
